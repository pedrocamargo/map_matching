...
class Trip:
    ...
    def pre_process(self):
        ...
        self.gps_trace["traveled_time"] = (
            self.gps_trace["timestamp"] - self.gps_trace["prev_timestamp"]
        ).dt.seconds.astype(float)
        self.gps_trace["speed"] = (self.gps_trace["traveled_time"] != 0) * (
            self.gps_trace["distance"] / (self.gps_trace["traveled_time"] / 3600)
        )
